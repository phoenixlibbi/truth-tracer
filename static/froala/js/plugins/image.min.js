...
! function(e, t) {
    ...
    Le = Le && Le.hasOwnProperty("default") ? Le["default"] : Le, Object.assign(Le.POPUP_TEMPLATES, {
            ...
            t.onload = function() {
                ...
                if (l) {
                    ...
                    for (var i = e.get(0).attributes, n = 0; n < i.length; n++) {
                        var r = i[n];
                        0 === r.nodeName.indexOf("data-") ? e.removeAttr(r.nodeName) : s && s.hasOwnProperty(r.nodeName) && e.removeAttr(r.nodeName)
                    }
                    if (void 0 !== s)
                        for (t in s) s.hasOwnProperty(t) && "link" != t && e.attr("".concat(t), s[t]);
        ...
        function Y(e, t, a) {
            ...
            if (t && void 0 !== t)
                for (i in t) t.hasOwnProperty(i) && "link" != i && (" data-".concat(i, '="').concat(t[i], '"'), n.attr("".concat(i), t[i]));
