...
! function(a, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(require("froala-editor")) : "function" == typeof define && define.amd ? define(["froala-editor"], t) : t(a.FroalaEditor)
}(this, function(a) {
    "use strict";
        ...
        return {
            apply: function c(a) {
                ...
                for (var m = 0; m < s.length; m++)
                    if (s[m].tagName != a && !h.node.isList(s[m])) {
                        var d = f(s[m]);
                        "LI" == s[m].tagName ? g(d, a) : "LI" == s[m].parentNode.tagName && s[m] ? (i = d, p = a, l = h.html.defaultTag(), p && p.toLowerCase() != l || (p = 'div class="fr-temp-div"'), i.replaceWith(f("<" + p + ">").html(i.html()))) : 0 <= ["TD", "TH"].indexOf(s[m].parentNode.tagName) ? (r = d, n = a, o = h.html.defaultTag(), n || (n = 'div class="fr-temp-div"' + (h.node.isEmpty(r.get(0), !0) ? ' data-empty="true"' : "")), n.toLowerCase() == o ? (h.node.isEmpty(r.get(0), !0) || r.append("<br/>"), r.replaceWith(r.html())) : r.replaceWith(f("<" + n + ">").html(r.html()))) : (t = d, (e = a) || (e = 'div class="fr-temp-div"' + (h.node.isEmpty(t.get(0), !0) ? ' data-empty="true"' : "")), "H1" != e && "H2" != e && "H3" != e && "H4" != e && "H5" != e || !h.node.attributes(t.get(0)).includes("font-size:") ? t.replaceWith(f("<" + e + " " + h.node.attributes(t.get(0)) + ">").html(t.html()).removeAttr("data-empty")) : t.replaceWith(f("<" + e + " " + h.node.attributes(t.get(0)).replace(/font-size:[0-9]+px;?/, "") + ">").html(t.html()).removeAttr("data-empty")))
                    }
