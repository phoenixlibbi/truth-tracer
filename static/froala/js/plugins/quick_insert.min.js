...
! function(e, t) {
    ...
    p = p && p.hasOwnProperty("default") ? p["default"] : p, Object.assign(p.DEFAULTS, {
        ...
        p.QUICK_INSERT_BUTTONS[e] = Object.assign({
            undo: !0
        }, t)
        ...
        function n(e) {
            ...
            a.hasClass("fr-on") && 0 <= t && l.css("top", t - i), 0 <= t && t - Math.abs(i) <= r.$box.outerHeight() - e.outerHeight() ? (a.hasClass("fr-hidden") ? (a.hasClass("fr-on") && u(), a.removeClass("fr-hidden")) : a.hasClass("fr-visible") && (a.addClass("fr-hidden"), d()), a.css("top", t - i)) : a.css("top", i), a.css("left", n)
        }
        ...
        function u(e) {
            if (e && e.preventDefault(), a.hasClass("fr-on") && !a.hasClass("fr-hidden")) d();
            else {
