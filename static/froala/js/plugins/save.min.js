    ...
    e = e && e.hasOwnProperty("default") ? e["default"] : e, Object.assign(e.DEFAULTS, {
        ...
        function a(e) {
            ...
            if ("string" == typeof t && (e = t), i.opts.saveURL) {
                var s = {};
                for (var a in i.opts.saveParams)
                    if (i.opts.saveParams.hasOwnProperty(a)) {
                        var o = i.opts.saveParams[a];
                        s[a] = "function" == typeof o ? o.call(this) : o
                    }
                var r = {};
                r[i.opts.saveParam] = e, f(this).ajax({
                    ...
                    headers: i.opts.requestHeaders,
                        ...
                        l = n, i.events.trigger("save.after", [e])
                    },
                    fail: function(e) {
        ...
        return s[v] = "Missing saveURL option.", s[c] = "Something went wrong during save.", {
            _init: function r() {
                if (i.opts.letteringClass)
                    for (var e = i.opts.letteringClass, t = i.$el.find(".".concat(e)).length, s = 0; s < t; s++) i.$el.find(".".concat(e))[s].innerHTML = i.$el.find(".".concat(e))[s].innerText.replace(/([\w'-]+|[?.",])/g, "<span class = 'fr-word-select'>$1</span>");
                i.opts.saveInterval && (l = i.html.get(), i.events.on("contentChanged", function() {
                    setTimeout(o, i.opts.saveInterval)
