    ...
    me = me && me.hasOwnProperty("default") ? me["default"] : me, Object.assign(me.POPUP_TEMPLATES, {
                    ...
                    R.events.$on(e, "focus", "[tabIndex]", function(e) {
                        ...
                        if (me.KEYCODE.ARROW_UP == l || me.KEYCODE.ARROW_DOWN == l || me.KEYCODE.ARROW_LEFT == l || me.KEYCODE.ARROW_RIGHT == l) {
                            if (t.is("span.fr-table-cell")) {
                                ...
                                var c = i * o + s,
                                    f = x(n.get(c));
                                d(f), R.events.disableBlur(), f.focus(), a = !1
                            }
        ...
        function g(e, t, a) {
            ...
            if (e < (t = Math.min(t, c[0].length - 1)))
                for (n = e; n <= t; n++)
                    if (!(e < n && c[0][n] == c[0][n - 1]) && 1 < (o = Math.min(parseInt(c[0][n].getAttribute("colspan"), 10) || 1, t - e + 1)) && c[0][n] == c[0][n + 1])
                        for (i = o - 1, l = 1; l < c.length; l++)
                            if (c[l][n] != c[l - 1][n]) {
                                for (r = n; r < n + o; r++)
                                    if (1 < (s = parseInt(c[l][r].getAttribute("colspan"), 10) || 1) && c[l][r] == c[l][r + 1]) r += i = Math.min(i, s - 1);
                                    else if (!(i = Math.max(0, i - 1))) break;
                                if (!i) break
                            }
            i && v(c, i, "colspan", 0, c.length - 1, e, t)
        }
        ...
        function m(e, t, a) {
            ...
            if (e < (t = Math.min(t, c.length - 1)))
                for (l = e; l <= t; l++)
                    if (!(e < l && c[l][0] == c[l - 1][0]) && 1 < (o = Math.min(parseInt(c[l][0].getAttribute("rowspan"), 10) || 1, t - e + 1)) && c[l][0] == c[l + 1][0])
                        for (i = o - 1, n = 1; n < c[0].length; n++)
                            if (c[l][n] != c[l][n - 1]) {
                                for (r = l; r < l + o; r++)
                                    if (1 < (s = parseInt(c[r][n].getAttribute("rowspan"), 10) || 1) && c[r][n] == c[r + 1][n]) r += i = Math.min(i, s - 1);
                                    else if (!(i = Math.max(0, i - 1))) break;
                                if (!i) break
                            }
            i && v(c, i, "rowspan", e, t, 0, c[0].length - 1)
        }

        function v(e, t, a, l, n, r, o) {
            var s, i, c;
            for (s = l; s <= n; s++)
                for (i = r; i <= o; i++) l < s && e[s][i] == e[s - 1][i] || r < i && e[s][i] == e[s][i - 1] || 1 < (c = parseInt(e[s][i].getAttribute(a), 10) || 1) && (1 < c - t ? e[s][i].setAttribute(a, c - t) : e[s][i].removeAttribute(a))
        }
            ...
            return null == (e = e || null) && 0 < Z().length && (e = Q()), e && e.findVisible("tr").not(e.find("> table tr")).each(function(s, e) {
                ...
                t.find("> th, > td").each(function(e, t) {
                    for (var a = x(t), l = parseInt(a.attr("colspan"), 10) || 1, n = parseInt(a.attr("rowspan"), 10) || 1, r = s; r < s + n; r++)
                        for (var o = i; o < i + l; o++) c[r] || (c[r] = []), c[r][o] ? i++ : c[r][o] = t;
                    i += l
                })
            }), c
        }
        ...
        function I(e, t) {
            if (x(e).is(t)) E(), x(e).addClass("fr-selected-cell");
            else {
                D(), R.edit.off();
                var a = _(),
                    l = $(e, a),
                    ...
                    r = function h(e, t, a, l, n) {
                        var r, o, s, i, c = e,
                            ...
                            d = a,
                            p = l;
                        for (r = c; r <= f; r++)(1 < (parseInt(x(n[r][d]).attr("rowspan"), 10) || 1) || 1 < (parseInt(x(n[r][d]).attr("colspan"), 10) || 1)) && (i = y((s = $(n[r][d], n)).row, s.col, n), c = Math.min(s.row, c), f = Math.max(i.row, f), d = Math.min(s.col, d), p = Math.max(i.col, p)), (1 < (parseInt(x(n[r][p]).attr("rowspan"), 10) || 1) || 1 < (parseInt(x(n[r][p]).attr("colspan"), 10) || 1)) && (i = y((s = $(n[r][p], n)).row, s.col, n), c = Math.min(s.row, c), f = Math.max(i.row, f), d = Math.min(s.col, d), p = Math.max(i.col, p));
                        for (o = d; o <= p; o++)(1 < (parseInt(x(n[c][o]).attr("rowspan"), 10) || 1) || 1 < (parseInt(x(n[c][o]).attr("colspan"), 10) || 1)) && (i = y((s = $(n[c][o], n)).row, s.col, n), c = Math.min(s.row, c), f = Math.max(i.row, f), d = Math.min(s.col, d), p = Math.max(i.col, p)), (1 < (parseInt(x(n[f][o]).attr("rowspan"), 10) || 1) || 1 < (parseInt(x(n[f][o]).attr("colspan"), 10) || 1)) && (i = y((s = $(n[f][o], n)).row, s.col, n), c = Math.min(s.row, c), f = Math.max(i.row, f), d = Math.min(s.col, d), p = Math.max(i.col, p));
                        return c == e && f == t && d == a && p == l ? {
                            min_i: e,
                            max_i: t,
                            min_j: a,
                            max_j: l
                ...
                for (var o = r.min_i; o <= r.max_i; o++)
                    for (var s = r.min_j; s <= r.max_j; s++) x(e).closest("table").is(x(a[o][s]).closest("table")) && x(a[o][s]).addClass("fr-selected-cell")
            }
        }
        ...
        function e(e) {
            ...
            if (0 < Z().length && !t && N(), !R.edit.isDisabled() || R.popups.isVisible("table.edit"))
                if (1 != e.which || 1 == e.which && R.helpers.isMac() && e.ctrlKey)(3 == e.which || 1 == e.which && R.helpers.isMac() && e.ctrlKey) && t && N();
                else if (r = !0, t) {
                0 < Z().length && !e.shiftKey && N(), e.stopPropagation(), R.events.trigger("image.hideResizer"), R.events.trigger("video.hideResizer"), n = !0;
                var a = t.tagName.toLowerCase();
                e.shiftKey && 0 < R.$el.find("".concat(a, ".fr-selected-cell")).length ? x(R.$el.find("".concat(a, ".fr-selected-cell")).closest("table")).is(x(t).closest("table")) ? I(l, t) : D() : ((R.keys.ctrlKey(e) || e.shiftKey) && (1 < Z().length || 0 === x(t).find(R.selection.element()).length && !x(t).is(R.selection.element())) && D(), l = t, 0 < R.opts.tableEditButtons.length && I(l, l))
            }
        }
        ...
        function a(e) {
            ...
            if (n || R.$tb.is(e.target) || R.$tb.is(x(e.target).closest(".fr-toolbar")) || (0 < Z().length && R.toolbar.enable(), E()), !(1 != e.which || 1 == e.which && R.helpers.isMac() && e.ctrlKey)) {
                if (r = !1, n) n = !1, T(e) || 1 != Z().length ? 0 < Z().length ? R.selection.isCollapsed() ? h() : (E(), R.edit.on()) : Z().length || (R.$el.removeClass("fr-no-selection"), R.edit.on()) : E();
                if (A) {
                    ...
                    R.opts.iframe && (t -= R.$iframe.offset().left), O.data("release-position", t), O.removeData("max-left"), O.removeData("max-right"),
                        function C() {
                            var e = O.data("origin"),
                            ...
                            if (e !== t) {
                                ...
                                if (R.undo.canDo() || R.undo.saveStep(), null != a && null != l) {
                                    var o, s, i, c = _(n),
                                        ...
                                        p = [],
                                        h = [];
                                    for (o = 0; o < c.length; o++) s = x(c[o][a]), i = x(c[o][l]), f[o] = s.outerWidth(), p[o] = i.outerWidth(), d[o] = f[o] / r * 100, h[o] = p[o] / r * 100;
                                    for (o = 0; o < c.length; o++)
                                        if (s = x(c[o][a]), i = x(c[o][l]), c[o][a] != c[o][l]) {
                                            var u = (d[o] * (f[o] + t - e) / f[o]).toFixed(4);
        ...
        function K(e) {
            if (!(x(e.currentTarget).is(x(e.originalEvent.relatedTarget)) || e.currentTarget.contains(e.originalEvent.relatedTarget) || e.originalEvent.relatedTarget && e.originalEvent.relatedTarget.contains(e.currentTarget)) && (R.events.$on(x("input"), "click", ee), !0 === n && 0 < R.opts.tableEditButtons.length)) {
        ...
        function z(e, t, a) {
            0 < x(".tribute-container").length && "none" != x(".tribute-container").css("display") || (0 < e.row ? R.selection.setAtEnd(a[e.row - 1][e.col]) : B(0, t, 0, "up"))
        }

        function k(e, t, a) {
            if (!(0 < x(".tribute-container").length && "none" != x(".tribute-container").css("display"))) {
        ...
        function L(e, t) {
            var a = x(t),
                l = a.closest("table"),
                n = l.parent();
            if (t && "TD" != t.tagName && "TH" != t.tagName && (0 < a.closest("td").length ? t = a.closest("td") : 0 < a.closest("th").length && (t = a.closest("th"))), !t || "TD" != t.tagName && "TH" != t.tagName) O && a.get(0) != O.get(0) && a.parent().get(0) != O.get(0) && R.core.sameInstance(O) && Y();
            else {
                ...
                if (Math.abs(e.pageX - r) <= R.opts.tableResizerOffset || Math.abs(o - e.pageX) <= R.opts.tableResizerOffset) {
                    ...
                    "rtl" != R.opts.direction ? e.pageX - r <= R.opts.tableResizerOffset ? (c = r, 0 < h.col ? (f = r - j(h.col - 1, p) + R.opts.tableResizingLimit, d = r + j(h.col, p) - R.opts.tableResizingLimit, s = h.col - 1, i = h.col) : (s = null, i = 0, f = l.offset().left - 1 - parseInt(l.css("margin-left"), 10), d = l.offset().left - 1 + l.width() - p[0].length * R.opts.tableResizingLimit)) : o - e.pageX <= R.opts.tableResizerOffset && (c = o, u.col < p[u.row].length && p[u.row][u.col + 1] ? (f = o - j(u.col, p) + R.opts.tableResizingLimit, d = o + j(u.col + 1, p) - R.opts.tableResizingLimit, s = u.col, i = u.col + 1) : (s = u.col, i = null, f = l.offset().left - 1 + p[0].length * R.opts.tableResizingLimit, d = n.offset().left - 1 + n.width() + parseFloat(n.css("padding-left")))) : o - e.pageX <= R.opts.tableResizerOffset ? (c = o, 0 < h.col ? (f = o - j(h.col, p) + R.opts.tableResizingLimit, d = o + j(h.col - 1, p) - R.opts.tableResizingLimit, s = h.col, i = h.col - 1) : (s = null, i = 0, f = l.offset().left + p[0].length * R.opts.tableResizingLimit, d = n.offset().left - 1 + n.width() + parseFloat(n.css("padding-left")))) : e.pageX - r <= R.opts.tableResizerOffset && (c = r, u.col < p[u.row].length && p[u.row][u.col + 1] ? (f = r - j(u.col + 1, p) + R.opts.tableResizingLimit, d = r + j(u.col, p) - R.opts.tableResizingLimit, s = u.col + 1, i = u.col) : (s = u.col, i = null, f = n.offset().left + parseFloat(n.css("padding-left")), d = l.offset().left - 1 + l.width() - p[0].length * R.opts.tableResizingLimit)), O || function E() {
                        R.shared.$table_resizer || (R.shared.$table_resizer = x(document.createElement("div")).attr("class", "fr-table-resizer").html("<div></div>")), O = R.shared.$table_resizer, R.events.$on(O, "mousedown", function(e) {
                            return !R.core.sameInstance(O) || (0 < Z().length && N(), 1 == e.which ? (R.selection.save(), A = !0, O.addClass("fr-moving"), D(), R.edit.off(), O.find("div").css("opacity", 1), !1) : void 0)
                    ...
                    var m = c - R.win.pageXOffset - R.opts.tableResizerOffset - R.$wp.offset().left,
                    ...
                    if (R.opts.iframe) {
                        ...
                        m += R.$iframe.offset().left + C, v += R.$iframe.offset().top + w, f += R.$iframe.offset().left, d += R.$iframe.offset().left
                    }
                    O.data("max-left", f), O.data("max-right", d), O.data("origin", c - R.win.pageXOffset), O.css("top", v), O.css("left", m), O.css("height", g), O.find("div").css("height", g), O.css("padding-left", R.opts.tableResizerOffset), O.css("padding-right", R.opts.tableResizerOffset), O.show()
        ...
        function F(e, t) {
            ...
            c || q(), R.$box.append(c), c.data("instance", R);
            var a, l = x(t).find("tr").first(),
                n = e.pageX,
                r = 0,
                o = 0;
            if (R.opts.iframe) {
        ...
        function V(e) {
            ...
            R.opts.tableResizer && (!R.popups.areVisible() || R.popups.areVisible() && R.popups.isVisible("table.edit")) && L(e, t), !R.opts.tableInsertHelper || R.popups.areVisible() || R.$tb.hasClass("fr-inline") && R.$tb.isVisible() || function r(e, t) {
                if (0 === Z().length) {
                    var a, l, n;
                    if (t && ("HTML" == t.tagName || "BODY" == t.tagName || R.node.isElement(t)))
                        for (a = 1; a <= R.opts.tableInsertHelperOffset; a++) {
        ...
        function G(e) {
            if (1 < Z().length && r && D(), !1 === r && !1 === n && !1 === A) o && clearTimeout(o), R.edit.isDisabled() && !R.popups.isVisible("table.edit") || (o = setTimeout(V, 30, e));
            else if (A) {
        ...
        function q() {
            R.shared.$ti_helper || (R.shared.$ti_helper = x(document.createElement("div")).attr("class", "fr-insert-helper").html('<a class="fr-floating-btn" role="button" tabIndex="-1" title="'.concat(R.language.translate("Insert"), '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a>')), R.events.bindClick(R.shared.$ti_helper, "a", function() {
                ...
                W()
            }, !0)), c = R.shared.$ti_helper, R.events.on("destroy", function() {
                c = null
        ...
        function Q() {
            var e = Z();
            if (e.length) {
                for (var t = e[0]; t && t.parentNode != R.el;) t = t.parentNode;
        ...
        return {
                    ...
                    A = n = r = !1, R.events.$on(R.$el, "mousedown", e), R.popups.onShow("image.edit", function() {
                        ...
                        e.shiftKey ? !1 === function o(e) {
                            ...
                            if (a.length && ("TD" == (a = a[0]).tagName || "TH" == a.tagName)) {
                                ...
                                if (l && "TABLE" == l.tagName && (me.KEYCODE.ARROW_LEFT == t || me.KEYCODE.ARROW_UP == t || me.KEYCODE.ARROW_RIGHT == t || me.KEYCODE.ARROW_DOWN == t) && (0 < Z().length && N(), R.browser.webkit && (me.KEYCODE.ARROW_UP == t || me.KEYCODE.ARROW_DOWN == t))) {
                        ...
                        if (!1 === function l(e) {
                                if (e.which == me.KEYCODE.TAB) {
                                    var t;
                                    if (0 < Z().length) t = R.$el.find(".fr-selected-cell").last();
                                    else {
            ...
            insert: function ae(e, t) {
                var a, l, n = "<table " + (R.opts.tableDefaultWidth ? 'style="width: ' + R.opts.tableDefaultWidth + ';" ' : "") + 'class="fr-inserted-table"><tbody>',
                    r = 100 / t;
                for (a = 0; a < e; a++) {
            ...
            deleteRow: function le() {
                ...
                if (0 < e.length) {
                    var t, a, l, n = _(),
                        r = M(n);
                    if (null == r) return;
                    if (0 === r.min_i && r.max_i == n.length - 1) u();
                    else {
                            ...
                            for (l = x(e.find("tr").not(e.find("> table tr")).get(t)), a = 0; a < n[t].length; a++)
                                if (0 === a || n[t][a] != n[t][a - 1]) {
                                    ...
                                    if (t < n.length - 1 && n[t][a] == n[t + 1][a] && (0 === t || n[t][a] != n[t - 1][a])) {
                                        for (var i = n[t][a], c = a; 0 < c && n[t][c] == n[t][c - 1];) c--;
                                        0 === c ? x(e.find("tr").not(e.find("> table tr")).get(t + 1)).prepend(i) : x(n[t + 1][c - 1])[0].parentNode && x(n[t + 1][c - 1])[0].insertAdjacentElement("afterend", i)
                                    }
                                }
                            var f = l.parent();
                            l.remove(), 0 === f.find("tr").length && f.remove(), n = _(e)
                        }
            ...
            insertColumn: function ne(i) {
                ...
                if (0 < e.length) {
                    var c, f = _(),
                        t = M(f);
                    c = "before" == i ? t.min_j : t.max_j;
                    var a, d = 100 / f[0].length,
                        p = 100 / (f[0].length + 1);
                    e.find("th, td").each(function() {
                        ...
                        for (var t, a = x(this), l = 0, n = 0; l - 1 < c;) {
                            if (!(t = a.find("> th, > td").get(n))) {
                                t = null;
                                break
                            }
                            t == f[e][l] ? (l += parseInt(x(t).attr("colspan"), 10) || 1, n++) : (l += parseInt(x(f[e][l]).attr("colspan"), 10) || 1, "after" == i && (t = 0 === n ? -1 : a.find("> th, > td").get(n - 1)))
                        }
                        var r, o = x(t);
                        if ("after" == i && c < l - 1 || "before" == i && 0 < c && f[e][c] == f[e][c - 1]) {
                            if (0 === e || 0 < e && f[e][c] != f[e - 1][c]) {
            ...
            deleteColumn: function re() {
                ...
                if (0 < e.length) {
                    var t, a, l, n = _(),
                        r = M(n);
                    if (null == r) return;
                    if (0 === r.min_j && r.max_j == n[0].length - 1) u();
                    else {
                        var o = 0;
                        for (t = 0; t < n.length; t++)
                            for (a = 0; a < n[0].length; a++)(l = x(n[t][a])).hasClass("fr-selected-cell") || (l.data("old-width", l.outerWidth() / e.outerWidth() * 100), (a < r.min_j || a > r.max_j) && (o += l.outerWidth() / e.outerWidth() * 100));
                        for (o /= n.length, a = r.max_j; a >= r.min_j; a--)
                            for (t = 0; t < n.length; t++)
                                if (0 === t || n[t][a] != n[t - 1][a])
                                    if (l = x(n[t][a]), 1 < (parseInt(l.attr("colspan"), 10) || 1)) {
            ...
            mergeCells: function oe() {
                if (1 < Z().length && (0 === R.$el.find("th.fr-selected-cell").length || 0 === R.$el.find("td.fr-selected-cell").length)) {
                    ...
                    for (e = c.length - 1; 0 <= e; e--) x(c[e]).remove();
                ...
                if (1 == Z().length) {
                    ...
                    if (1 < t) {
                        ...
                        for (c = 0; c < r.length; c++)
                            if (0 === c || r[c][o.col] != r[c - 1][o.col]) {
                                var f = x(r[c][o.col]);
                                if (!f.is(e)) {
                                    var d = (parseInt(f.attr("colspan"), 10) || 1) + 1;
                                    f.attr("colspan", d)
                                }
                            }
            ...
            splitCellHorizontally: function ie() {
                if (1 == Z().length) {
                    ...
                    if (1 < l) {
                        ...
                        for (var i = r.row + s, c = 0 === r.col ? r.col : r.col - 1; 0 <= c && (n[i][c] == n[i][c - 1] || 0 < i && n[i][c] == n[i - 1][c]);) c--; - 1 == c ? x(a.find("tr").not(a.find("> table tr")).get(i)).prepend(o) : x(n[i][c])[0].parentNode && x(n[i][c])[0].insertAdjacentElement("afterend", o[0])
                    } else {
                        var f, d = x(document.createElement("tr")).append(o);
                        for (f = 0; f < n[0].length; f++)
                            if (0 === f || n[r.row][f] != n[r.row][f - 1]) {
                                var p = x(n[r.row][f]);
            ...
            removeHeader: function fe() {
                var e = Q(),
                    t = e.find("thead");
                if (0 < t.length)
                    if (0 === e.find("tbody tr").length) u();
                    else if (t.remove(), 0 < Z().length) h();
                else {
